...
// TODO insert or update with annotated
public class AnnotatedInsertOrUpdateMethodGenerator extends InsertOrUpdateMethodGenerator {

    public AnnotatedInsertOrUpdateMethodGenerator(boolean isSimple) {
        super(isSimple);
    }
